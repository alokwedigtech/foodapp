        ...
        return (
            ...
            <View style={styles.recycleconatiner}>
                <View style={styles.kgplastic}>
                    <Text style={styles.kgtext}>{item.month}</Text>
                </View>
                <View style={styles.kgplastic}>
                    <Text style={[styles.kgtext, { color: '#62bd44' }]}> + {item.weight}</Text>
                </View>
            </View>
                ...
                <View style={styles.pagecontainer}>
                    ...
                    <View style={styles.login}>
                        <View style={styles.innersearch}>
                            ...
                            <View style={styles.recycleconatiner}>
                                <View style={styles.kgplastic}>
                                    <Text style={styles.kgtext}>75 Kg</Text>
                                    <Text style={styles.plastictext}> Plastic</Text>
                                </View>
                                <View style={styles.kgplastic}>
                                    <Text style={[styles.kgtext, { color: '#62bd44' }]}> +85.55</Text>
